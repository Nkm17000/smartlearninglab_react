...
export default function FlashcardsScreen(){
 const [cards,setCards]=useState(null),[show,setShow]=useState(false),[front,setFront]=useState(''),[back,setBack]=useState('');
 const load=()=>api.flashcards().then(setCards).catch(e=>Alert.alert('Flashcards',e.message)); useEffect(load,[]);
