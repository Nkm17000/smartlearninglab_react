...
export default function CommunityScreen(){
 ...
 const add=async()=>{try{await api.createCommunityPost({title,content});setTitle('');setContent('');setShow(false);load()}catch(e){console.warn('[Student API] Community:', e?.message || e)}};
